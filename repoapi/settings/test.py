...
class Test(Common):
    RESULTS_DIR = values.Value("/tmp", environ_name="RESULTS")
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": join(Common.BASE_DIR, "db.sqlite3"),
        }
    }
    ...
    WORKFRONT_CREDENTIALS = join(Common.BASE_DIR, ".workfront.ini")
    WORKFRONT_NOTE = True
    ...
    # build app
    BUILD_KEY_AUTH = True
    BUILD_REPOS_SCRIPTS_CONFIG_DIR = join(
        Common.BASE_DIR, "build", "fixtures", "config"
    )
