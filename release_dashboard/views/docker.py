...
from release_dashboard.utils import trigger_docker_build
from release_dashboard.utils import get_docker_repositories
from release_dashboard.utils import get_docker_tags
...
class DockerImageList(APIView):

    def get(self, request, project, tag=None, _format=None):
        return Response(_get_docker_tags(project, tag))
