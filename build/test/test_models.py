...
class BuildReleaseManagerTestCase(TestCase):
    ...
    def test_release_jobs_uuids(self):
    ...
    def test_failed_projects_list(self):
        br = BuildRelease.objects.get(pk=1)
        self.assertListEqual(br.failed_projects_list, [])

        br = BuildRelease.objects.get(pk=2)
        self.assertListEqual(br.failed_projects_list, ["kamailio"])
